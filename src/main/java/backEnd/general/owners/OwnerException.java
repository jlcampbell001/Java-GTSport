...
public class OwnerException extends Exception {
    ...
    /**
     * The error message for not finding an owner record based on the primary
     * key.
     */
    ...
    /**
     * The error message for trying to save an owner record but another owner
     * already has that name.
     */
    public static final String OWNER_NAME_EXISTS_ALREADY_ERROR = "An owner with the name already exists: ";

    /**
     * The error message for trying to delete the owner but the owner is in use
     * in another table.
     */
