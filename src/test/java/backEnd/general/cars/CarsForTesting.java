...
public class CarsForTesting {
    ...
    private static final DriveTrain CAR_1_DRIVETRAIN = DriveTrain.FR;
    private static final Aspiration CAR_1_ASPIRATION = Aspiration.NA;
    ...
    private static final DriveTrain CAR_2_DRIVETRAIN = DriveTrain.FR;
    private static final Aspiration CAR_2_ASPIRATION = Aspiration.NA;
    ...
    private static final DriveTrain CAR_3_DRIVETRAIN = DriveTrain.FR;
    private static final Aspiration CAR_3_ASPIRATION = Aspiration.NA;
    ...
    private static final DriveTrain CAR_4_DRIVETRAIN = DriveTrain.RR;
    ...
    private static final DriveTrain CAR_5_DRIVETRAIN = DriveTrain.FR;
    private static final Aspiration CAR_5_ASPIRATION = Aspiration.NA;
    ...
    private static final DriveTrain CAR_6_DRIVETRAIN = DriveTrain.FR;
    private static final Aspiration CAR_6_ASPIRATION = Aspiration.NA;
    ...
    private static final DriveTrain CAR_7_DRIVETRAIN = DriveTrain.EMPTY;
    private static final Aspiration CAR_7_ASPIRATION = Aspiration.EMPTY;
    ...
    private static final DriveTrain CAR_8_DRIVETRAIN = DriveTrain.MR;
    private static final Aspiration CAR_8_ASPIRATION = Aspiration.NA;
    ...
    private static final DriveTrain CAR_9_DRIVETRAIN = DriveTrain.FOURWD;
    private static final Aspiration CAR_9_ASPIRATION = Aspiration.NA;
     ...
     */
    public static final Car CAR1 = new Car(CAR_1_KEY, CAR_1_NAME, CAR_1_DEALER_KEY, CAR_1_YEAR,
     ...
     * Testing data for a car.
     */
    public static final Car CAR2 = new Car(CAR_2_KEY, CAR_2_NAME, CAR_2_DEALER_KEY, CAR_2_YEAR,
     ...
     * Testing data for a car.
     */
    public static final Car CAR3 = new Car(CAR_3_KEY, CAR_3_NAME, CAR_3_DEALER_KEY, CAR_3_YEAR,
     ...
     * Testing data for a car.
     */
    public static final Car CAR4 = new Car(CAR_4_KEY, CAR_4_NAME, CAR_4_DEALER_KEY, CAR_4_YEAR,
     ...
     * Testing data for a car.
     */
    public static final Car CAR5 = new Car(CAR_5_KEY, CAR_5_NAME, CAR_5_DEALER_KEY, CAR_5_YEAR,
     ...
     * Testing data for a car.
     */
    public static final Car CAR6 = new Car(CAR_6_KEY, CAR_6_NAME, CAR_6_DEALER_KEY, CAR_6_YEAR,
     ...
     * Testing data for a car.
     */
    public static final Car CAR7 = new Car(CAR_7_KEY, CAR_7_NAME, CAR_7_DEALER_KEY, CAR_7_YEAR,
     ...
     * Testing data for a car.
     */
    public static final Car CAR8 = new Car(CAR_8_KEY, CAR_8_NAME, CAR_8_DEALER_KEY, CAR_8_YEAR,
     ...
     * Testing data for a car.
     */
    public static final Car CAR9 = new Car(CAR_9_KEY, CAR_9_NAME, CAR_9_DEALER_KEY, CAR_9_YEAR,
