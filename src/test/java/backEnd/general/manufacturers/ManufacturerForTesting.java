...
public class ManufacturerForTesting {
     ...
     * Test data for a manufacturer.
     */
    public static final Manufacturer MANUFACTURER3 = new Manufacturer(MANUFACTURER_3_KEY, MANUFACTURER_3_NAME, MANUFACTURER_3_COUNTRY_KEY);

    /**
     * Test data for a manufacturer.
     */
    public static final Manufacturer MANUFACTURER4 = new Manufacturer(MANUFACTURER_4_KEY, MANUFACTURER_4_NAME, MANUFACTURER_4_COUNTRY_KEY);

    /**
     * Test data for a manufacturer.
     */
    public static final Manufacturer MANUFACTURER5 = new Manufacturer(MANUFACTURER_5_KEY, MANUFACTURER_5_NAME, MANUFACTURER_5_COUNTRY_KEY);

    /**
     * Test data for a manufacturer.
     */
    public static final Manufacturer MANUFACTURER6 = new Manufacturer(MANUFACTURER_6_KEY, MANUFACTURER_6_NAME, MANUFACTURER_6_COUNTRY_KEY);

    /**
     * Test data for a manufacturer.
     */
    public static final Manufacturer MANUFACTURER7 = new Manufacturer(MANUFACTURER_7_KEY, MANUFACTURER_7_NAME, MANUFACTURER_7_COUNTRY_KEY);

    /**
     * Test data for a manufacturer.
     */
    public static final Manufacturer MANUFACTURER8 = new Manufacturer(MANUFACTURER_8_KEY, MANUFACTURER_8_NAME, MANUFACTURER_8_COUNTRY_KEY);

    /**
     * Test data for a manufacturer.
     */
    public static final Manufacturer MANUFACTURER9 = new Manufacturer(MANUFACTURER_9_KEY, MANUFACTURER_9_NAME, MANUFACTURER_9_COUNTRY_KEY);
}
